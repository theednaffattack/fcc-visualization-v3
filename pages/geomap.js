...
const alps = [
    ...
    },
    {
      ...
      URL:
        "https://www.independent.co.uk/sport/drugs-in-sport-indurain-allowed-to-use-banned-drug-1379584.html"
    },
    {
      Time: "38:14",
      Place: 8,
...
const formattedAlpsData = alps.map(x => ({
  x: new Date(
    2012,
    0,
    1,
...
console.log(
  alps[2]["Time"].slice(3, 5).length < 2
    ? parseInt(alps[2]["Time"].slice(0, 2))
  ...
  <div id="blah">
    ...
    <FlexContainer>
      <Row>
        ...
        <FlexItem>
          <GeoMercator width={900} height={500} data={formattedAlpsData} />
        </FlexItem>
