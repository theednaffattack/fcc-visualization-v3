...
export const formattedDate = someDate => {
  ...
  switch (mm) {
    case "01":
      return `${textMonths[1]["short"]} ${dd}, ${yyyy}`;
      break;
    case "02":
      return `${textMonths[2]["short"]} ${dd}, ${yyyy}`;
      break;
    case "03":
      return `${textMonths[3]["short"]} ${dd}, ${yyyy}`;
      break;
    case "04":
      return `${textMonths[4]["short"]} ${dd}, ${yyyy}`;
      break;
    case "05":
      return `${textMonths[5]["short"]} ${dd}, ${yyyy}`;
      break;
    case "06":
      return `${textMonths[6]["short"]} ${dd}, ${yyyy}`;
      break;
    case "07":
      return `${textMonths[7]["short"]} ${dd}, ${yyyy}`;
      break;
    case "08":
      return `${textMonths[8]["short"]} ${dd}, ${yyyy}`;
      break;
    case "09":
      return `${textMonths[9]["short"]} ${dd}, ${yyyy}`;
      break;
    case 10:
      return `${textMonths[10]["short"]} ${dd}, ${yyyy}`;
      break;
    case 11:
      return `${textMonths[11]["short"]} ${dd}, ${yyyy}`;
      break;
    case 12:
      return `${textMonths[12]["short"]} ${dd}, ${yyyy}`;
      break;
    default:
      return mm;
  }
